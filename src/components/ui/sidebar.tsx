...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: Not needed
  ...
  if (isMobile) {
    return (
      <Sheet onOpenChange={setOpenMobile} open={openMobile} {...props}>
        <SheetContent
          className="bg-sidebar/50 text-sidebar-foreground w-(--sidebar-width) p-0 backdrop-blur-sm [&>button]:hidden"
          data-mobile="true"
...
function SidebarMenuButton({
  ...
  isActive?: boolean;
  tooltip?: string | TooltipPrimitive.Popup.Props;
  ...
  return (
    <ul
      className={cn(
        ...
        "group-data-[side=right]:mr-3.5 group-data-[side=right]:pr-2.5",
        "group-data-[side=left]:ml-3.5 group-data-[side=left]:pl-2.5",
        "group-data-[collapsible=icon]:hidden",
        className,
      )}
