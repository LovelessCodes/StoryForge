...
#[derive(Serialize, Deserialize, Clone, Debug, Copy, PartialEq, Eq, Enumeration)]
#[repr(i32)]
...
pub struct LandClaim {
    ...
    pub areas: Vec<Cuboidi>,
    #[prost(int32, tag = "2", default = "0")]
    pub protection_level: i32,
    #[prost(int64, tag = "3", default = "0")]
    pub owned_by_entity_id: i64,
    #[prost(string, tag = "4")]
    pub owned_by_player_uid: String,
    #[prost(uint32, tag = "5", default = "0")]
    pub owned_by_player_group_uid: u32,
    #[prost(string, tag = "6")]
    pub last_known_owner_name: String,
    #[prost(string, tag = "7")]
    pub description: String,
    #[prost(map = "int32, int32", tag = "8")]
    pub permitted_player_group_ids: HashMap<i32, i32>,
    #[prost(map = "string, int32", tag = "9")]
    pub permitted_player_uids: HashMap<String, i32>,
    #[prost(map = "string, string", tag = "10")]
    pub permitted_player_last_known_player_name: HashMap<String, String>,
...
pub struct ServerWorldPlayerData {
    ...
    pub inventories_serialized: HashMap<String, Vec<u8>>,
    #[prost(bytes, tag = "3")]
    pub entity_player_serialized: Vec<u8>,
    ...
    pub spawn_position: Option<PlayerSpawnPos>,
    #[prost(map = "string, bytes", tag = "15")]
    pub mod_data: HashMap<String, Vec<u8>>,
...
pub struct GameData {
    ...
    pub player_data_by_uid: HashMap<String, ServerWorldPlayerData>,
    #[prost(int32, tag = "7", default = "0")]
    pub seed: i32,
    ...
    pub land_claims: Vec<LandClaim>,
    #[prost(map = "string, float", tag = "28")]
    pub time_speed_modifiers: HashMap<String, f32>,
    #[prost(string, tag = "29")]
    pub play_style: String,
    #[prost(string, tag = "30")]
    pub world_type: String,
    #[prost(bytes, tag = "31")]
    pub world_config_bytes: Vec<u8>,
    #[prost(string, tag = "32")]
    pub play_style_lang_code: String,
    #[prost(int32, tag = "33", default = "0")]
    pub last_block_item_mapping_version: i32,
    #[prost(string, tag = "34")]
    pub savegame_identifier: String,
    #[prost(float, tag = "35", default = "0")]
    pub calendar_speed_mul: f32,
    #[prost(map = "string, bool", tag = "36")]
    pub remappings_applied_by_code: HashMap<String, bool>,
    ...
    pub default_spawn: Option<PlayerSpawnPos>,
}
...
pub struct MapMarker {
    ...
    pub position: Option<MapMarkerPos>,
    #[prost(string, tag = "10")]
    pub label: String,
    #[prost(string, tag = "11")]
    pub id: String,
...
pub struct ProspectingResult {
    ...
    pub readings: Option<ProspectReading>,
}
...
pub struct ProspectMarker {
    ...
    pub results: Vec<ProspectingResult>,
}

#[derive(Serialize, Deserialize, Clone, PartialEq, Message)]
pub struct ProspectingLog {
    #[prost(message, repeated, tag = "1")]
    pub markers: Vec<ProspectMarker>,
}
